...
import (
	...
	"github.com/aryangodara/go-interpreter/ast"
...
func testLetStatement(t *testing.T, s ast.Statement, name string) bool {
	...
	if letStmt.Name.Token.Literal != name {
		t.Errorf("letStmt.Name.TokenLiteral() not %s. got=%s", name, letStmt.Name.Token.Literal)
		return false
	}
...
func TestIdentifierExpression(t *testing.T) {
	...
	if len(program.Statements) != 1 {
		t.Errorf("program does not contain 1 statement. got=%d", len(program.Statements))
	}
